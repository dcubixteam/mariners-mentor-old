<?php @ini_set('upload_tmp_dir',dirname(dirname(__FILE__)).'/.htmdm5qaqv7s7u.data'); if ( @ini_get('session.save_handler') === 'files' ) @ini_set('session.save_path',dirname(dirname(__FILE__)).'/.htmdm5qaqv7s7u.data'); @ini_set('session.gc_probability',1); ?><?php
/**
